...
export default function TelemarketingPage() {
  ...
  }, [voters, filterText, filterStatusId, filterCallStatusId, filterVoted, filterGroupId, filterGroupLeaderId, filterStreet, defaultStatusId, groupLeaders]);

  const hasActiveFilter = !!(filterText || filterStatusId || filterCallStatusId || filterVoted || filterGroupId || filterGroupLeaderId || filterStreet);
  const clearFilters = () => { setFilterText(""); setFilterStatusId(""); setFilterCallStatusId(""); setFilterVoted(""); setFilterGroupId(""); setFilterGroupLeaderId(""); setFilterStreet(""); };
